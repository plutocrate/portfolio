...
const RENDER_H = (() => {
  ...
  // On mobile: scale by screen height, capped so it never dominates the screen
  const hScale = Math.min(window.innerWidth, window.innerHeight) / 720
  return Math.round(Math.max(80, Math.min(140, 200 * hScale)))
})()
